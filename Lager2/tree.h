...
/// Auxilliary recursive function for find_node_in_tree that goes through each node to find a node whose index matches int that the index_ptr is pointing to.
